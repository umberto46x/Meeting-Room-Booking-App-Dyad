...
const Index = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-full"> {/* Adjusted min-h and removed p-4 */}
