...
const Index = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 min-h-[calc(100vh-64px)]"> {/* Adjusted min-h */}
